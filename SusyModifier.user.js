...
<form class='insertform' method='get' action='https://susy.mdpi.com/special_issue_pending/list/search' target='_blank'><input type='text' name='show_all' value='my_journals' style='display:none;'>SI Title: <input type='text' name='form[si_name]' id='si-search2' style='display:inline-block; width:65%;'> <input type='submit' class='submit' value='SI Search'></form><hr> <form class='insertform' method='get' action='https://susy.mdpi.com/user/ebm/management/all/my_journals' target='_blank'>Name: <input type='text' id='form_name2' name='form[name]' style='display:inline-block; width:65%;'><br>Email: <input type='email' id='form_email2' name='form[email]' style='display:inline-block; width:65%;'> <input type='submit' class='submit' value='EBM Search'></form><hr>";
        ...
        $("[data-menu='editorial_office'] > li > [href='/special_issue_pending/list']").after(" <a href='https://susy.mdpi.com/special_issue_pending/list/online?sort_field=special_issue_pending.publish_date&sort=DESC'>[O]</a> <a href='https://susy.mdpi.com/special_issue_pending/list/online?form[journal_id]=154&form[section_id]=893&show_all=my_journals&sort_field=special_issue_pending.deadline&sort=ASC'>[Z]</a> <a href='https://susy.mdpi.com/special_issue_pending/list/online?form[journal_id]=154&form[section_id]=895&show_all=my_journals&sort_field=special_issue_pending.deadline&sort=ASC'>[F]</a>");
        ...
        $("[data-menu='editorial_office'] > li > [href='/user/managing/status/submitted']").after(" <a href='https://susy.mdpi.com/user/managing/status/all?form[journal_id]=154&form[section_id]=895&sort_field=submission_manuscript_state.last_action&sort=DESC'>[F]</a>");
