...
function onInit() {
    ...
    var userNamesEncoded = ["YWJjc3luYS5tdXh5eg==", "YWJjc3VzaWUuaHVhbmd4eXo=", "YWJjaGVsZW5lLmh1eHl6", "YWJjbGlubi5saXh5eg==", "YWJjZGViYnkucGVuZ3h5eg==", "YWJjZ2xhZHlzLmxpeHl6", "YWJjY29ubmVsbHkueWFuZ3h5eg==", "YWJjZWxsZS5jYWl4eXo=", "YWJjaGFpbGV5LnRhbmd4eXo=",
                            "YWJjaW5uYS5odWFuZ3h5eg==", "YWJjY2FzcGVyLnhpZXh5eg==", "YWJjZGFuaWVsLmRhbnh5eg==", "YWJjZWlsZWVuLnpoYW5neHl6", "YWJjZWRlbi54aWF4eXo=", "YWJjc2hlcnlsLnh1eHl6", "YWJjcnVvbmFuLmNoZW54eXo="];
    ...
    if (window.location.href.indexOf("susy.mdpi.com/") > -1 && GM_config.get('Interface_sidebar') && $('#leftcol').length) {
        try {
            ...
            $("#owner").click(function () {
                let p = $("a[href='/user/super/status/ongoing']").length ? "super" : "managing";
                $.getJSON("/user/ajax/search_manuscript_owner?term=" + $("#topmenu span:contains('@mdpi.com')").text(), d => location.href = `/user/${p}/status/submitted?form[owner_id][]=${d[0].value}`);
            });
            ...
            if (window.location.hostname.indexOf("scopus") > -1) {
                ...
                if (window.location.pathname.indexOf('authid/detail.uri') > -1 || /\/pages\/authors\/\d+/.test(window.location.pathname)) {
                    waitForKeyElements('h1[data-testid="author-profile-name"]', function (h1node) {
                        ...
                        if (!authorId) return;
                        GM_addStyle(`
                            .sk-scopus-card{border:1px solid #c6d5eb;border-radius:10px;padding:14px;margin:14px 0;background:#fff;color:#202124;font-size:15px}
                            .sk-scopus-toolbar{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:10px}.sk-scopus-toolbar strong{margin-right:auto;font-size:18px;color:#1558d6;font-weight:700}
                            .sk-scopus-heading strong{margin-right:0}.sk-scopus-card>strong{font-size:18px;color:#1558d6}
                            .sk-scopus-btn{border:1px solid #1a73e8;border-radius:6px;padding:6px 10px;background:#1a73e8;color:#fff;cursor:pointer;font:inherit;font-weight:600;white-space:nowrap}
                            .sk-scopus-btn:hover{background:#1558d6}.sk-scopus-btn:disabled{opacity:.6;cursor:default}
                            .sk-scopus-icon{display:inline-flex;align-items:center;justify-content:center;border:0;padding:0 3px;background:none;color:#1a73e8;font-size:20px;line-height:1.2;cursor:pointer;text-decoration:none}
                            .sk-scopus-icon:hover{color:#d93025;text-decoration:none}.sk-scopus-note{font-size:13px;color:#444;line-height:1.5}
                            #sk-coauthors-section .sk-scopus-icon{font-size:13px!important;width:18px;height:18px;min-width:0!important;min-height:0!important;padding:0!important;line-height:1!important;flex-shrink:0}
                            .sk-scopus-years{display:flex;flex-wrap:wrap;gap:8px;margin:12px 0}.sk-scopus-year{min-width:68px;padding:7px 10px;border-radius:8px;background:#e8f0fe;text-align:center}
                            .sk-scopus-year span{display:block;font-size:13px;color:#333}.sk-scopus-year a,.sk-scopus-year b{display:block;font-size:22px;font-weight:700;color:#1a73e8;line-height:1.4}
                            .sk-scopus-year a:hover{color:#d93025}.sk-scopus-year-current{background:#fff0da}.sk-scopus-year-current a,.sk-scopus-year-current b{color:#c65b00}
                            .sk-scopus-bars{display:grid;gap:12px;margin-top:14px}.sk-scopus-bar-label{display:flex;justify-content:space-between;gap:10px;margin-bottom:5px;font-size:14px}
                            .sk-scopus-bar-label span{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}.sk-scopus-bar-label b{flex-shrink:0;font-weight:700;color:#1558d6}
                            .sk-scopus-bar-track{height:8px;border-radius:4px;background:#dfe9f7;overflow:hidden}.sk-scopus-bar-fill{height:100%;border-radius:4px;background:#1a73e8}
                            .sk-scopus-distribution{display:grid;grid-template-rows:minmax(0,1fr) minmax(0,1fr);gap:12px;min-height:0}
                            .sk-scopus-distribution>div{min-width:0;overflow:auto;padding:12px;border-radius:8px;background:#f0f6ff;border-left:4px solid #1a73e8}
                            .sk-scopus-distribution>div>strong{font-size:17px;color:#1558d6}.sk-scopus-distribution>div:nth-child(2){background:#f6efff;border-left-color:#a142f4}
                            .sk-scopus-distribution>div:nth-child(2)>strong,.sk-scopus-distribution>div:nth-child(2) b{color:#7b1fa2}
                            .sk-scopus-scroll{overflow:auto;min-width:0;min-height:0;border:1px solid #c6d5eb;border-radius:7px}
                            .sk-scopus-table{border-collapse:separate;border-spacing:0;width:100%;font-size:15px;text-align:left;color:#202124}
                            .sk-scopus-table th{position:sticky;top:0;z-index:1;background:#1a73e8;color:#fff;font-weight:600;white-space:nowrap}
                            .sk-scopus-table th,.sk-scopus-table td{padding:7px 8px;border-bottom:1px solid #dce5f2;vertical-align:top;line-height:1.5}
                            #sk-publications-section .sk-scopus-table th,#sk-publications-section .sk-scopus-table td{padding:4px 8px;line-height:1.35}
                            .sk-scopus-table tr:nth-child(even) td{background:#f4f8ff}.sk-scopus-table tbody tr:hover td{background:#e8f0fe}
                            .sk-scopus-table a{color:#1a0dab;text-decoration:none}.sk-scopus-table a:hover{text-decoration:underline}
                            #sk-coa-overlay{position:fixed;inset:0;background:rgba(25,38,52,.5);z-index:10000;display:flex;align-items:center;justify-content:center;padding:12px}
                            #sk-coa-popup{box-sizing:border-box;width:94vw;height:90vh;display:flex;flex-direction:column;gap:10px;background:#fff;color:#202124;font-size:14px;border-radius:12px;padding:14px;box-shadow:0 12px 48px #152c4940}
                            #sk-coa-popup:not(.sk-coa-detailed){width:min(440px,94vw);height:min(76vh,680px)}
                            #sk-coa-popup>.sk-scopus-toolbar{margin:0;flex-wrap:nowrap;flex-shrink:0}#sk-coa-popup>.sk-scopus-toolbar .sk-scopus-note{max-width:36vw;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                            #sk-coa-body{display:grid;grid-template-columns:minmax(0,1fr);gap:14px;flex:1;min-height:0}#sk-coa-popup.sk-coa-detailed #sk-coa-body{grid-template-columns:minmax(0,1fr) clamp(240px,20vw,320px)}
                            #sk-coa-popup:not(.sk-coa-detailed) .sk-scopus-distribution{display:none}
                        ...
                        fetch('https://www.scopus.com/api/authors/' + authorId, { signal: AbortSignal.timeout(15000) }).then(r => {
                            if (!r.ok) throw new Error('HTTP ' + r.status);
                            return r.json();
                        }).then(d => {
                            if (String(d.authorId) !== authorId) throw new Error('Unexpected author profile');
                            authorProfile = d;
                        ...
                        function skInjectHirschSection() {
                            ...
                            function postData(display) {
                                return fetch(dataUrl, {
                                    ...
                                    body: 'display=' + display + '&' + baseBody, signal: AbortSignal.timeout(20000)
                                }).then(r => { if (!r.ok) throw new Error('HTTP ' + r.status); return r.json(); });
                            }

                            // 按钮样式
                            function makeBtn(text) {
                                const btn = $('<button type="button">' + text + '</button>').css({
                                    background: '#2f709b', color: '#fff', border: 'none',
                            ...
                            function triggerLoad() {
                                ...
                                fetch(hirschPageUrl, { credentials: 'include', signal: AbortSignal.timeout(20000) }).then(r => {
                                    ...
                                    return Promise.allSettled([postData('hIndex'), postData('CoAuthors')]).then(results => [
                                        results[0].status === 'fulfilled' ? results[0].value : {},
                                        results[1].status === 'fulfilled' ? results[1].value : {}, docData
                                    ]);
                                }).then(([hData, coData, docData]) => {
                                    seeAllBtn.hide();
                                    seeCoBtn.hide();
                                    $('#sk-hirsch-content, #sk-subject-overlay, #sk-coauthors-section, #sk-sources-section').remove();
                                    inlineLoadBtn.text('✅').css({ cursor: 'default', opacity: '1' }).off('click');
                                    const content = $('<div id="sk-hirsch-content"></div>');

                                    // 学科按论文数计算覆盖率；同一篇论文可以属于多个学科。
                                    const docTotal = Number(docData.docCount ?? docData.totalDataForSourceData?.noOfDocuments);
                                    ...
                                    if (subjectAreas.length) {
                                        ...
                                        const saOverlay = $('<div id="sk-subject-overlay"></div>').css({ background: 'rgba(255,255,255,0.97)', borderRadius: '12px', boxShadow: '0 2px 12px rgba(0,0,0,0.1)', padding: '14px 18px', lineHeight: '1.8', margin: '14px 0 16px' });
                                        saOverlay.append($('<strong></strong>').text('Subject Areas').css({ display: 'block', marginBottom: '6px', fontSize: '16px', color: '#202124' }));
                                        [...subjectAreas].sort((a, b) => Number(b.noOfDocuments) - Number(a.noOfDocuments)).forEach((s, i) => {
                                            const bg = saColors[i % saColors.length];
                                            const pct = docTotal > 0 ? ' (' + (Number(s.noOfDocuments) / docTotal * 100).toFixed(1) + '%)' : '';
                                            const isMath = s.code === 'MATH' || /^Mathematics$/i.test(s.displayName);
                                            saOverlay.append($('<span></span>').text(s.displayName + ' · ' + s.noOfDocuments + pct).css({
                                                ...
                                                background: bg + '18', color: bg, border: '1px solid ' + bg + '40', fontWeight: isMath ? '800' : '500', fontSize: isMath ? '16px' : '14px'
                                            }));
                                        });
                                        h1node.parent().append(saOverlay);
                                    }

                                    const yearData = [...(docData.documentYearDataViewBeans || [])].sort((a, b) => Number(b.code || b.displayName) - Number(a.code || a.displayName));
                                    // 补齐已有年份之间的空档，保留最早、最晚年份的范围。
                                    for (let i = 1; i < yearData.length; i++) {
                                        const previousYear = Number(yearData[i - 1].code || yearData[i - 1].displayName), nextYear = Number(yearData[i].code || yearData[i].displayName);
                                        if (Number.isInteger(previousYear) && Number.isInteger(nextYear) && previousYear > nextYear + 1) {
                                            yearData.splice(i, 0, { code: String(previousYear - 1), displayName: String(previousYear - 1), noOfDocuments: 0 });
                                        }
                                    }
                                    const docs = Array.isArray(hData.hirschGraphData) ? hData.hirschGraphData : [];
                                    ...
                                    if (yearData.length || docs.length) {
                                        ...
                                        yearData.forEach(y => {
                                            ...
                                            yearCounts.append($('<div class="sk-scopus-year"></div>').toggleClass('sk-scopus-year-current', current)
                                                .append($('<span></span>').text((y.displayName || y.code) + (current ? ' (YTD)' : '')))
                                                .append(Number(y.noOfDocuments) === 0 ? $('<b>0</b>') : $('<a target="_blank" rel="noopener"></a>').attr('href', y.url || hirschPageUrl).text(y.noOfDocuments)));
                                        });
                                        if (yearData.length) pubBox.append(yearCounts);
                                        const types = docData.documentTypeDataViewBeans || [];
                                        if (types.length) pubBox.append($('<div class="sk-scopus-note"></div>').css('margin-bottom', '8px').text(types.map(t => t.displayName + ': ' + t.noOfDocuments).join(' · ')));

                                        // 年度数据下方完整展示文章列表。
                                        const pubBody = $('<tbody></tbody>');
                                        docs.forEach((d, i) => {
                                            const title = d.documentTitle || '?';
                                            let href = hirschPageUrl;
                                            try { const url = new URL(d.detailsUrl, 'https://www.scopus.com'); if (url.protocol === 'https:' && url.hostname === 'www.scopus.com') href = url.href; } catch (e) { }
                                            const link = $('<a target="_blank" rel="noopener"></a>').attr('href', href).text(title);
                                            if (geometry_regex.test(title)) link.css({ background: 'Aquamarine', padding: '1px 4px', borderRadius: '3px' });
                                            else if (maths_regex.test(title)) link.css({ background: 'Wheat', padding: '1px 4px', borderRadius: '3px' });
                                            pubBody.append($('<tr></tr>').append($('<td></td>').text(i + 1)).append($('<td></td>').append(link)).append($('<td></td>').css({ textAlign: 'right', fontWeight: '700', color: '#1a73e8' }).text(d.count ?? '—')));
                                        });
                                        if (docs.length) pubBox.append($('<table class="sk-scopus-table"><thead><tr><th>#</th><th>Title</th><th>Cited</th></tr></thead></table>').append(pubBody));
                                        content.append(pubBox);
                                    }

                                    // 共同作者按 Scopus ID 保存；同名的不同档案不擅自合并。
                                    const coauthors = Array.isArray(coData.coAuthorsViewBeans) ? coData.coAuthorsViewBeans : [];
                                    if (coauthors.length) {
                                        const coRows = [...new Map(coauthors.filter(c => /^\d+$/.test(String(c.coAuthorId)) && String(c.coAuthorId) !== authorId).map(c => {
                                            let name = String(c.coAuthorName || '?').replace(/\+/g, ' ');
                                            try { name = decodeURIComponent(name); } catch (e) { }
                                            const nm = name.match(/^(.+?),\s*(.+)$/);
                                            return [String(c.coAuthorId), { id: String(c.coAuthorId), name, first: nm ? nm[2].trim() : name, last: nm ? nm[1].trim() : '', shared: c.noOfCoAuthoredDocuments ?? null, profile: null, state: 'Not loaded', error: '' }];
                                        })).values()].sort((a, b) => Number(b.shared) - Number(a.shared) || a.name.localeCompare(b.name));
                                        const coSection = $('<div id="sk-coauthors-section" class="sk-scopus-card"></div>');
                                        ...
                                        function renderCoauthors() {
                                            const loadedRows = coRows.filter(row => row.profile);
                                            const countries = new Map(), institutions = new Map(), institutionNames = new Map();
                                            let countryKnown = 0, institutionKnown = 0, sameInstitution = 0;
                                            loadedRows.forEach(row => {
                                                const institution = row.profile.latestAffiliatedInstitution;
                                                const country = institution?.address?.country;
                                                if (country && country !== 'null') { countryKnown++; countries.set(country, (countries.get(country) || 0) + 1); }
                                                if (institution?.name) {
                                                    const key = String(institution.id || institution.name);
                                                    institutionKnown++; institutions.set(key, (institutions.get(key) || 0) + 1); institutionNames.set(key, institution.name);
                                                }
                                            ...
                                            coTable.closest('#sk-coa-popup').toggleClass('sk-coa-detailed', detailsRequested);
                                            const columns = detailsRequested ? [
                                            ...
                                            columns.forEach(([label, width, numeric]) => {
                                                ...
                                                heading.append($('<th></th>').toggleClass('sk-scopus-number', !!numeric).text(label));
                                            });
                                            coTable.find('thead').empty().append(heading);
                                            countrySummary.empty();
                                            for (const [label, counts, known] of [['Countries', countries, countryKnown], ['Institutions', institutions, institutionKnown]]) {
                                                const chart = $('<div></div>').append($('<strong></strong>').text(label + (loadedRows.length ? ' · ' + known + '/' + loadedRows.length : '')));
                                            ...
                                            coRows.forEach(row => {
                                                const p = row.profile, institution = p?.latestAffiliatedInstitution;
                                                const name = p?.preferredName?.full || row.name;
                                                const nameCell = $('<td></td>').attr('title', name + (row.error ? ' · ' + row.error : '')).css({ color: '#1558d6', fontWeight: '700' }).text(name);
                                                if (row.state === 'Failed') nameCell.append(' ⚠');
                                        ...
                                        coExportIcon.on('mousedown', e => { if (e.which === 2 || e.button === 1) e.preventDefault(); }).on('auxclick', function (e) {
                                            if ((e.originalEvent?.button ?? e.button) !== 1) return;
                                            e.preventDefault();
                                            if (!$('#sk-coa-overlay').length) $(this).trigger('click');
                                            if (!detailRunning) detailTask = loadCoauthorDetails();
                                        }).on('click', function () {
                                            if ($('#sk-coa-overlay').length) { overlay.find('#sk-inner-copy-btn').trigger('focus'); return; }
                                            tip = $('<span class="sk-scopus-note" role="status"></span>');
                                            countrySummary = $('<div class="sk-scopus-distribution"></div>');
                                            tableBody = $('<tbody></tbody>');
                                            coTable = $('<table class="sk-scopus-table"><colgroup></colgroup><thead></thead></table>').append(tableBody);
                                            const scroll = $('<div class="sk-scopus-scroll"></div>').append(coTable);
                                            let copyPending = false;
                                            const copyIcon = $('<button type="button" id="sk-inner-copy-btn" class="sk-scopus-btn">Copy</button>').on('click', function () {
                                                const textToCopy = allTsv;
                                                navigator.clipboard.writeText(textToCopy).then(() => {
                                                    tip.text('Copied'); setTimeout(() => { if (tip.text() === 'Copied') tip.text(''); }, 1500);
                                                }).catch(() => {
                                                    const copyText = $('<textarea readonly></textarea>').val(textToCopy).css({ position: 'fixed', left: '-9999px', top: '0' }).appendTo(popup);
                                                    let copied = false;
                                                    try { copyText[0].select(); copied = document.execCommand('copy'); } catch (e) { } finally { copyText.remove(); }
                                                    tip.text(copied ? 'Copied' : 'Copy failed');
                                                });
                                            }).on('mousedown', e => { if (e.which === 2 || e.button === 1) e.preventDefault(); }).on('auxclick', async function (e) {
                                                if ((e.originalEvent?.button ?? e.button) !== 1) return;
                                                e.preventDefault();
                                                ...
                                                try {
                                                    ...
                                                    if (popup[0].isConnected) tip.text('Loading failed; middle-click Copy to retry.');
                                            ...
                                            popup.append($('<div id="sk-coa-body"></div>').append(scroll, countrySummary));
                                            overlay = $('<div id="sk-coa-overlay"></div>').append(popup).on('keydown', e => { if (e.key === 'Escape') closeBtn.trigger('click'); });
                                            $('body').append(overlay); renderCoauthors(); copyIcon.trigger('focus');
                                        });
                                        coSection.append($('<div class="sk-scopus-toolbar sk-scopus-heading"></div>').append($('<strong></strong>').text('Co-authors (' + coRows.length + ')')).append(coExportIcon)).append(coCompact);
                                        (authorPos.length ? authorPos : content).append(coSection);
                                        renderCoauthors();
                                    }

                                    if (!Array.isArray(hData.hirschGraphData) || !Array.isArray(coData.coAuthorsViewBeans)) {
                                        loaded = false;
                                        content.append($('<div class="sk-scopus-note"></div>').text('Some publication or co-author data could not be loaded. ').append($('<button type="button" class="sk-scopus-btn">Retry missing analysis</button>').on('click', triggerLoad)));
                                        inlineLoadBtn.text('↻').css({ cursor: 'pointer', opacity: '1' }).off('click').on('click', triggerLoad);
                                    }

                                    // ── 来源表格 → 插入右栏，保留折叠，展开时完整显示 ──
                                    const sources = [...(docData.documentSourceDataViewBeans || [])].sort((a, b) => Number(b.noOfDocuments) - Number(a.noOfDocuments));
                                    if (sources.length && authorPos.length) {
                                        const maxSourceDocs = Math.max(1, ...sources.map(s => Number(s.noOfDocuments) || 0));
                                        const srcSection = $('<details id="sk-sources-section" class="sk-scopus-card" open></details>');
                                        srcSection.append($('<summary></summary>').css({ fontSize: '18px', fontWeight: '700', color: '#1558d6', cursor: 'pointer', marginBottom: '10px' }).text('Sources (' + sources.length + ')'));
                                        const srcTable = $('<table></table>').css({ width: '100%', borderCollapse: 'collapse', fontSize: '15px' });
                                        srcTable.append($(`<thead><tr><th style="text-align:left;padding:4px 6px;border-bottom:2px solid #c6d5eb;color:#202124;font-weight:600">Source</th><th style="text-align:right;padding:4px 6px;border-bottom:2px solid #c6d5eb;color:#202124;
                                        font-weight:600;width:40px">Docs</th></tr></thead>`));
                                        const srcTbody = $('<tbody></tbody>');
                                        sources.forEach((s, i) => {
                                            const srcTr = $('<tr></tr>').css({ borderBottom: '1px solid #dce5f2', backgroundImage: 'linear-gradient(to right, #d2e3fc ' + (Number(s.noOfDocuments) / maxSourceDocs * 100) + '%, transparent 0%)' });
                                    ...
                                    loaded = false;
                                    seeAllBtn.show().text('Retry author analysis').prop('disabled', false).css({ opacity: '1' });
                                    seeCoBtn.show().text('Retry author analysis').prop('disabled', false).css({ opacity: '1' });
                                    inlineLoadBtn.text('↻').css({ cursor: 'pointer', opacity: '1' }).off('click').on('click', triggerLoad);
                                    $('#sk-hirsch-error').remove();
                                    section.append($('<div id="sk-hirsch-error" class="sk-scopus-note"></div>').text('Author analysis could not be loaded. Retry or ').append($('<a target="_blank" rel="noopener">open Scopus analysis</a>').attr('href', hirschPageUrl)));
                                });
                            }
...
//             });
    ...
    if (window.location.href.indexOf("susy.mdpi.com") > -1 && GM_config.get('Old_Icon')) {
        try {
            ...
            #leftcol .menu li:not([class])::before{background-color: rgb(79, 86, 113);content: "";height: 6px;width: 6px;position: absolute;left: 4px;top: 8px;z-index: 1}
            #leftcol .menu-hr {display: none !important;}
            .light_green_theme #leftcol .menu li:not([class])::before {background-color: rgb(76, 142, 101) !important;}
...
function skGMFetchGet(url, timeout = 0) { return new Promise(resolve => { GM_xmlhttpRequest({ method: "GET", url: url, timeout, onload: resolve, onerror: resolve, ontimeout: resolve, onabort: resolve }); }) };
    ...
    *{box-sizing:border-box}html,body{margin:0;min-height:100%;background:#f3f6f8;color:#26343d;font-family:Arial,"Microsoft YaHei",sans-serif}body{padding:42px 18px}
    ...
    $('#sk-work-start').on('click', function () {
        ...
        let timer = setInterval(() => {
            ...
            if (current.run !== hubRun || Date.now() > Number(current.until || 0)) {
                clearInterval(timer);
                loginStarted = false;
            ...
            needLoginSites = needLoginSites.filter(id => {
                ...
                else if (s.text) $(`.sk-work-row[data-site="${id}"]`).attr('data-state', s.state).find('.sk-work-state').text(s.text);
                return s.state !== 'ok';
            });
...
function skWorkLoginHelper() {
    ...
    if (host === 'login.microsoftonline.com') { // 1. 微软统一登录页
        ...
        if (!['keycloak.mdpi.cn', 'auth.mdpi.com', 'auth.mdpi.cn'].some(k => loginUrl.includes(k))) return;
    ...
    pageTimer = setInterval(() => {
        if (!isCurrentRun()) { clearInterval(pageTimer); return; }
        ...
        // 企业认证自动继续；仅 SUSY / MDPI 的密码登录页提示人工 Continue。
        let btn = document.querySelector('a[href*="/mdpi_keycloak/login"]') || [...document.querySelectorAll('a,button')].find(el => /Continue as .*@mdpi\.com/i.test(el.textContent) || /(Microsoft MDPI|MDPI Microsoft) Authentication/i.test(el.textContent));
        if (btn) {
